...
// the opt_name is set to ambrox_opt.  Please replace it if change your opt_name name.
add_action( 'redux/page/ambrox_opt/enqueue', 'ambrox_faIconFont' );
function ambrox_faIconFont() {
	
  //  Font awesome enqueue
  wp_enqueue_style( 'font-awesome', AMBROX_DIR_CSS_URI.'font-awesome.min.css', array(), '4.7.0', 'all' );
  
  // Redux admin css enqueue
  wp_enqueue_style( 'ambrox-redux-admin', AMBROX_DIR_URI.'inc/redux-custom-field/assets/ambrox.redux.admin.css', array(), '1.0' );
  
  // Redux admin js enqueue
  wp_enqueue_script( 'ambrox-redux-admin', AMBROX_DIR_URI.'inc/redux-custom-field/assets/ambrox.redux.admin.js', array( 'jquery' ), '1.0', true );
