...
// image default alt
if( !function_exists( 'ambrox_img_default_alt' ) ){
	function ambrox_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'ambrox_img_tag' ) ){
	function ambrox_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = ambrox_img_default_alt( $site_name );
		}
...
// Anchor Tag
if( !function_exists( 'ambrox_anchor_tag' ) ){
	function ambrox_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'ambrox_heading_tag' ) ){
	function ambrox_heading_tag( array $args ){

		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => __( 'Write Something', 'ambrox' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'data-animate'=> '',
			'data-delay'  => '',
...
// Paragraph Tag
if( !function_exists( 'ambrox_paragraph_tag' ) ){
	function ambrox_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'ambrox_span_tag' ) ){
	function ambrox_span_tag( array $args ){
