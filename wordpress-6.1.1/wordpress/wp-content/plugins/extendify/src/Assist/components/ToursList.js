...
import { useTourStore, useTourStoreReady } from '@assist/state/Tours'
...
export const ToursList = () => {
    ...
    const completed = tours?.filter((tour) => wasOpened(tour.slug))
    ...
    return (
        <div className="my-4 w-full bg-white border border-gray-300 p-4 lg:p-8 rounded">
            ...
            <div
                ...
                <div className="bg-black bg-opacity-75 rounded w-full h-full p-6 absolute inset-0 flex md:hidden items-center justify-center z-10">
