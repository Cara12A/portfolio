...
export const SupportArticle = () => {
    ...
    if (loading) {
        return (
            <div className="w-full flex justify-center bg-white border border-gray-300 p-4 lg:p-8 rounded-b">
                <Spinner />
            </div>
        )
    }
    ...
    if (error) {
        return (
            <div className="w-full bg-white border border-gray-300 p-4 lg:p-8 rounded-b">
    ...
    return (
        <article className="relative mb-4 w-full text-base bg-white border border-gray-300 p-4 lg:p-8 rounded-b">
